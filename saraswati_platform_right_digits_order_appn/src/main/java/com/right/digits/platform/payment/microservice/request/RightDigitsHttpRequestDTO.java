package com.right.digits.platform.payment.microservice.request;

import com.right.digits.platform.payment.microservice.dtos.RightDigitsGeneralUniversalDTO;
