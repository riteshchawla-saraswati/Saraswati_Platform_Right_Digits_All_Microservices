package com.right.digits.platform.back.end.microservice.request;

import com.right.digits.platform.back.end.microservice.dtos.RightDigitsGeneralUniversalDTO;
