package com.right.digits.platform.functional.programming.microservice.entities;
...
public class RightDigitsGeneralUniversalEntity extends RightDigitsBasicCommonEntity {

    private RightDigitsStringEntity stringEntity;

    private RightDigitsDateEntity dateEntity;

    private RightDigitsDoubleEntity doubleEntity;

    private RightDigitsLongEntity longEntity;

    private RightDigitsObjectEntity objectEntity;
    ...
    public void initializeStringEntity(String dataString,
        ...
        stringEntity = new RightDigitsStringEntity();
    ...
    public void initializeDateEntity(Date dataDate,
        ...
        dateEntity = new RightDigitsDateEntity();
    ...
    public void initializeObjectEntity(Object dataObject,
        ...
        objectEntity = new RightDigitsObjectEntity();
    ...
    public void initializeDoubleEntity(Double dataDouble,
        ...
        doubleEntity = new RightDigitsDoubleEntity();
    ...
    public void initializeLongEntity(Long dataLong,
        ...
        longEntity = new RightDigitsLongEntity();
