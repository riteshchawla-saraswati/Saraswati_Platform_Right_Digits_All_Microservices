package com.right.digits.platform.api.gateway.microservice.request;

import com.right.digits.platform.api.gateway.microservice.dtos.RightDigitsGeneralUniversalDTO;
