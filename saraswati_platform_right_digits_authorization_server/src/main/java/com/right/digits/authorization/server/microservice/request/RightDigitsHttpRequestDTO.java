package com.right.digits.authorization.server.microservice.request;

import com.right.digits.authorization.server.microservice.dtos.RightDigitsGeneralUniversalDTO;
