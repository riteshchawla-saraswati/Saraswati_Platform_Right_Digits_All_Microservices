package com.right.digits.platform.appn.config.server.microservice.dtos;
...
public class RightDigitsGeneralUniversalDTO extends RightDigitsBasicCommonDTO {

    private RightDigitsStringDTO stringDTO;

    private RightDigitsDateDTO dateDTO;

    private RightDigitsDoubleDTO doubleDTO;

    private RightDigitsLongDTO longDTO;

    private RightDigitsObjectDTO objectDTO;
    ...
    public void initializeStringDTO(String dataString,
        ...
        stringDTO = new RightDigitsStringDTO();
    ...
    public void initializeDateDTO(Date dataDate,
        ...
        dateDTO = new RightDigitsDateDTO();
    ...
    public void initializeObjectDTO(Object dataObject,
        ...
        objectDTO = new RightDigitsObjectDTO();
    ...
    public void initializeDoubleDTO(Double dataDouble,
        ...
        doubleDTO = new RightDigitsDoubleDTO();
    ...
    public void initializeLongDTO(Long dataLong,
        ...
        longDTO = new RightDigitsLongDTO();
