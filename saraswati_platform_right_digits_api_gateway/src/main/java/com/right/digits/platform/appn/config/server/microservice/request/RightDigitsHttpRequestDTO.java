package com.right.digits.platform.appn.config.server.microservice.request;

import com.right.digits.platform.appn.config.server.microservice.dtos.RightDigitsGeneralUniversalDTO;
